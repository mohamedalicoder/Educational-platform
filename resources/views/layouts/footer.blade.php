<section class="contact-us" id="contact-section">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-12">
          <p class="copyright">Copyright © 2024 Co., Ltd. All Rights Reserved.

          <br>Design: <a rel="sponsored" href="" target="_blank">Mocoder</a>
          <br>Distribution: <a rel="sponsored" href="" target="_blank">Mocoder</a></p>
        </div>
      </div>
    </div>
  </section>
